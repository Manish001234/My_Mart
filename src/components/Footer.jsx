      ...
      <div className="foter">
        <Container>
          <Left>
            <Logo>My Mart</Logo>
            <Desc>
            My Mart Internet Private Limited,Buildings Alyssa, Begonia &Clove Embassy Tech Village,Outer Ring Road, Devarabeesanahalli Village,Bengaluru, 560103,Karnataka, India
